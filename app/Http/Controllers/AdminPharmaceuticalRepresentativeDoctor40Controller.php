<?php namespace App\Http\Controllers;
	...
	class AdminPharmaceuticalRepresentativeDoctor40Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "pharmaceutical_representative_doctor";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Id","name"=>"user_id","join"=>"users,id","visible" => false];
			$this->col[] = ["label"=>"Id","name"=>"doctor_id","join"=>"users,id"];

			$this->col[] = ["label"=>"Nome - Cognome","name"=>"user_id","callback_php"=>'App\Http\Controllers\AdminPipeGrupoController::convert_name_surname($row->doctor_id)'];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			$info = Cookie::get('id_info');
  
			$query->where('user_id','=', $info);
