<?php namespace App\Http\Controllers;
	...
	class AdminGroupUser37Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Group Id","name"=>"group_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"group,name"];
			# OLD END FORM
