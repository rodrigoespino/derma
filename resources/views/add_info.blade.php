        ...
        <form method="post" action="{{CRUDBooster::mainpath('add-save')}}">
            ...
            <div class="form-group">
                    ...
                    <label for="">Name </label> 
                      <label for=""></label>
                    <input required type="text" name="name" id="id" class="form-control input-sm"  >
                  </div>

                         <label for="">Surname </label> 
                        <input required type="text" name="surname" id="surname" class="form-control input-sm" >
                      </div>
                      
                        <div class="form-group">

                        <label required for="">Email </label> 
                            <input type="email" name="emilio" id="emilio" class="form-control input-sm"  >
                          </div> 
